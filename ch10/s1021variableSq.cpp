...
int main()
{
	...
	// 删除小于6的元素
	ivector2.erase(remove_if(ivector2.begin(), ivector2.end(), bind(less<int>(), placeholders::_1, 6)), ivector2.end());
	...
	// 将[ivector2.begin(), ivector2.begin()+3)
	// 和[ivector2.begin()+3, ivector2.end())
	// 两个区间的元素互换结果直接输出
