...
int main()
{
	...
	// 找出ivector之中小于7的元素的个数
	cout << count_if(ivector.begin(), ivector.end(), bind(less<int>(), placeholders::_1, 7))<<endl;

	// 找出ivector之中大于2的第一个元素所在位置的元素
	cout << *find_if(ivector.begin(), ivector.end(), bind(greater<int>(), placeholders::_1, 2))<<endl;
